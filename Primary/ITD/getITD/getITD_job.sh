...
$getITD -infer_sense_from_alignment True -min_read_copies 1 -plot_coverage True -require_indel_free_primers False -min_read_length 70 -min_bqs 20 -reference $reference -anno $anno $sample FLT3_R1.fq FLT3_R2.fq
conda deactivate
