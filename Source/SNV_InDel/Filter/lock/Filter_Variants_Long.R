...
var = var[(var$t_alt_count>=thresh.n.alt & var$DP>=thresh.dp & var$DP<=thresh.high.dp), ]
...
pon = read.table(paste0('/home/projects/cu_10184/projects/PTH/Reference/Filtering/', filter.style, '/SNPs_PoN.txt'),
                 header=TRUE, sep='\t')
