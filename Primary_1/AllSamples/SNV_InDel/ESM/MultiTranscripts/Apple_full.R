...
# Save the results.
write.table(SAAS, '/home/projects/cu_10184/projects/PTH/AllBatches_1/Result/SNV_InDel/MuTect2_1/ESM/MultiTranscripts/Apple_SAAS_full.txt',
            row.names=FALSE, col.names=TRUE, quote=FALSE, sep='\t')
write.table(rest, '/home/projects/cu_10184/projects/PTH/AllBatches_1/Result/SNV_InDel/MuTect2_1/ESM/MultiTranscripts/Apple_rest_full.txt',
            row.names=FALSE, col.names=TRUE, quote=FALSE, sep='\t')
