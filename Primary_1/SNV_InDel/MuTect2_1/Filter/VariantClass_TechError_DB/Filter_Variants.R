...
var = read.table(paste0(batch_dir, '/Lock/SNV_InDel/MuTect2_1/maf/', sam, '.maf'), header=TRUE, quote='', fill=TRUE, sep='\t')
...
res.dir = paste0(batch_dir, '/Result/SNV_InDel/MuTect2_1/', scheme_name)
