...
for (batch in batches)  {
  maf.dir = paste0('BatchWork_1/', batch, '/Result/SNV_InDel/MuTect2/', scheme.name)
...
# Save the results.
write.table(apple, paste0('AllBatches_1/Result/SNV_InDel/MuTect2/FilteredVariants_', scheme.name, '.txt'),
            row.names=FALSE, col.names=TRUE, quote=FALSE, sep='\t')
# write.xlsx(apple, paste0('AllBatches_1/Result/SNV_InDel/MuTect2/FilteredVariants_', scheme.name, '.xlsx'),
...
# Save the results.
write.table(long, paste0('AllBatches_1/Result/SNV_InDel/MuTect2/FilteredVariants_', scheme.name, '_Long.txt'), 
            row.names=FALSE, col.names=TRUE, quote=FALSE, sep='\t')
# write.xlsx(long, paste0('AllBatches_1/Result/SNV_InDel/MuTect2/FilteredVariants_', scheme.name, '_Long.xlsx'),
#            row.names=FALSE, col.names=TRUE, append=FALSE)

write.table(short, paste0('AllBatches_1/Result/SNV_InDel/MuTect2/FilteredVariants_', scheme.name, '_Short.txt'),
            row.names=FALSE, col.names=TRUE, quote=FALSE, sep='\t')
# write.xlsx(short, paste0('AllBatches_1/Result/SNV_InDel/MuTect2/FilteredVariants_', scheme.name, '_Short.xlsx'),
#            row.names=FALSE, col.names=TRUE, append=FALSE)
