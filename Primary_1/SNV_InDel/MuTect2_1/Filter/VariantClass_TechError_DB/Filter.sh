...
# log directory:
log_dir=${batch_dir}/log/SNV_InDel/MuTect2_1/Filter/${scheme_name}
rm -rf ${log_dir}
mkdir -p ${log_dir}

# error directory:
error_dir=${batch_dir}/error/SNV_InDel/MuTect2_1/Filter/${scheme_name}
rm -rf ${error_dir}
mkdir -p ${error_dir}
...
mkdir ${batch_dir}/Result/SNV_InDel/MuTect2_1/VariantClass
mkdir ${batch_dir}/Result/SNV_InDel/MuTect2_1/TechError
mkdir ${batch_dir}/Result/SNV_InDel/MuTect2_1/DB
...
do
  qsub -o ${log_dir}/${sam}.log -e ${error_dir}/${sam}.error -N ${batch}_${sam}_SNV_InDel_Filter_${scheme_name}  \
    ...
    /home/projects/cu_10184/projects/PTH/Code/Primary_1/SNV_InDel/MuTect2_1/Filter/${scheme_name}/Filter_job.sh
done
