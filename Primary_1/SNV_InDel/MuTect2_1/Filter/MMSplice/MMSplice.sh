####################################################################################################################
####################################################################################################################
# Get MMSplice scores for SNV-InDels in SpliceSite.
# Author: Haiying Kong
...
do
  qsub -o ${log_dir}/${sam}.log -e ${error_dir}/${sam}.error -N ${batch}_${sam}_${tool_name}  \
    ...
    /home/projects/cu_10184/projects/PTH/Code/Primary_1/SNV_InDel/MuTect2_1/Filter/${tool_name}/MMSplice_job.sh
done
