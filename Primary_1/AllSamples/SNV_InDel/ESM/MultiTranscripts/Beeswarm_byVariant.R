...
maf = maf[ ,c(3,13,16,17,20:25)]
maf = maf[!duplicated(maf[ ,1:2]), ]
...
tag = read.table('/home/projects/cu_10184/projects/PTH/AllBatches/Result/SNV_InDel/ClinicTag/CalledReferenceVariants.txt',
                 header=TRUE, sep='\t')
tag = tag[ ,c('Hugo_Symbol', 'Protein_Change')]
...
tag = tag[idx, ]
tag.label = paste(tag$Hugo_Symbol, tag$Protein_Change, sep='_')

# Tag our variant list.
aster = maf[ ,c(1:2,5:10)]
aster.label = paste(aster$Hugo_Symbol, aster$Protein_Change, sep='_')
...
####################################################################################################################
# Plot Beeswarm.
pdf('/home/projects/cu_10184/projects/PTH/AllBatches_1/Result/SNV_InDel/MuTect2_1/ESM/MultiTranscripts/Beeswarm_ESM_HorizenREDCap_byVariant.pdf')
...
####################################################################################################################
# Plot Beeswarm.
pdf('/home/projects/cu_10184/projects/PTH/AllBatches_1/Result/SNV_InDel/MuTect2_1/ESM/MultiTranscripts/Beeswarm_ESM_COSMIC_long_byVariant.pdf')
...
####################################################################################################################
# Plot Beeswarm.
pdf('/home/projects/cu_10184/projects/PTH/AllBatches_1/Result/SNV_InDel/MuTect2_1/ESM/MultiTranscripts/Beeswarm_ESM_COSMIC_short_byVariant.pdf')
