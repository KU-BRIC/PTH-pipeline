####################################################################################################################
####################################################################################################################
# Create script to create PoN for Step2 and Step3.
# Author: Haiying Kong
...
apple = rbind('rm -rf /home/projects/cu_10184/projects/PTH/AllBatches_1/Lock/SNV_InDel/MuTect2/PoN/tmp',
              'mkdir /home/projects/cu_10184/projects/PTH/AllBatches_1/Lock/SNV_InDel/MuTect2/PoN/tmp',
              'cd /home/projects/cu_10184/projects/PTH/AllBatches_1/Lock/SNV_InDel/MuTect2/PoN/tmp',
              'rm -rf /home/projects/cu_10184/projects/PTH/AllBatches_1/Lock/SNV_InDel/MuTect2/PoN/GenomicsDB',
              aster1)
...
apple = rbind(apple,
              'rm -f /home/projects/cu_10184/projects/PTH/Reference/MuTect2/pon.vcf.gz',
              aster2)
row.names(apple) = NULL
...
system('chmod +x /home/projects/cu_10184/projects/PTH/Code/Primary_1/SNV_InDel/MuTect2/PoN/Step2_Step3_Create_GenomicsDB_PoN_job.sh')
