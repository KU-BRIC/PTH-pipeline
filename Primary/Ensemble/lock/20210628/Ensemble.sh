...
mkdir -p ${Lock_SNV_InDel_dir}/VarDict/vcf
mkdir -p ${Lock_SNV_InDel_dir}/VarDict/maf
mkdir -p ${Lock_SNV_InDel_dir}/SNVer/vcf
mkdir -p ${Lock_SNV_InDel_dir}/SNVer/maf
mkdir -p ${Lock_SNV_InDel_dir}/LoFreq/vcf
mkdir -p ${Lock_SNV_InDel_dir}/LoFreq/maf
...
mkdir -p ${Lock_CNV_dir}/CNACS
mkdir -p ${Lock_CNV_dir}/CNVkit
...
mkdir ${Lock_ITD_dir}
mkdir ${Lock_ITD_dir}/VarDict
mkdir ${Lock_ITD_dir}/Pindel
mkdir ${Lock_ITD_dir}/ScanITD
mkdir ${Lock_ITD_dir}/getITD
mkdir ${Lock_ITD_dir}/IGV
...
do
  qsub -o ${log_dir}/${sample}.log -e ${error_dir}/${sample}.error -N ${batch}_${sample}_Ensemble \
    -v n_thread=${n_thread},target_chr=${target_chr},target_nochr=${target_nochr},target_nopad=${target_nopad},target_itd=${target_itd},batch=${batch},sample=${sample},fq_dir=${fq_dir},BAM_dir=${BAM_dir},Lock_SNV_InDel_dir=${Lock_SNV_InDel_dir},Result_SNV_InDel_dir=${Result_SNV_InDel_dir},Lock_CNV_dir=${Lock_CNV_dir},Lock_DOC_dir=${Lock_DOC_dir},Lock_ITD_dir=${Lock_ITD_dir},Result_ITD_dir=${Result_ITD_dir},temp_dir=${temp_dir} \
